...
- [ ] 数据质量/清洗规则及前后报告
- [ ] 固定分层训练/验证/测试索引
- [ ] 无泄漏 `ColumnTransformer`/`Pipeline`
- [ ] Age/Height/Weight 单变量分析与解释
- [ ] 双变量分析与解释
- [ ] 多变量分析与解释
- [ ] 相关性热力图与解释
- [ ] sklearn 逻辑回归基线、优化和最终模型
- [ ] sklearn MLP 基线、优化和最终模型
- [ ] 完整分类指标、混淆矩阵和分类报告
- [ ] 训练/推理耗时、实验配置和日志
- [ ] 模型、预处理器、标签和输入 schema 产物
- [ ] 阶段三自动化测试与验收记录
...
- [ ] 逻辑回归梯度/接口/收敛测试
- [ ] 手写前馈神经网络及激活函数
- [ ] 反向传播、Batch/Epoch 和参数更新
- [ ] 神经网络梯度/接口/收敛测试
- [ ] 四模型同划分、同标签、同指标对比
- [ ] Accuracy/P/R/F1（每类、macro、weighted）
- [ ] 四模型混淆矩阵和分类报告
- [ ] 训练时间、推理时间、复杂度、优缺点、场景分析
